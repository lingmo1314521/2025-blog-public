...
import { Image as ImageIcon, Globe, Monitor, Volume2, Info } from 'lucide-react'
import { useI18n } from '../i18n-context'
import { clsx } from '../utils'

const WALLPAPERS = [
  { name: 'Monterey', url: 'https://images.unsplash.com/photo-1477346611705-65d1883cee1e?q=80&w=3270&auto=format&fit=crop' },
  { name: 'Big Sur', url: 'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?q=80&w=2940&auto=format&fit=crop' },
  { name: 'Mojave', url: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=3270&auto=format&fit=crop' },
            ...
            {activeTab === 'wallpaper' && (
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {WALLPAPERS.map((wp) => (
                            <div key={wp.name} onClick={() => setWallpaper?.(wp.url)} className="group cursor-pointer space-y-2">
                    ...
                    <div className="text-xs text-gray-400 mt-4">{t('click_apply')}</div>
                </div>
            )}
